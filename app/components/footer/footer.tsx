    ...
    <div>
      <div className="bg-gray-900 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          ...
          <p className="text-white text-3xl font-bold">Movie <span className="text-red-500">Flex</span></p>          </a>
      ...
      <div className=" mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center pb-6"> © 2024-25 Movie Flex. All rights reserved.</div>
    </div>
