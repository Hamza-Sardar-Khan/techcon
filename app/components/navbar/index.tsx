...
const NavBar = () => {
    ...
    return (
      <>
        ...
        <div className="absolute top-0 glass h-100 z-30 w-full bg-transparent ">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">

            <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                <p className="text-white text-3xl font-bold">Movie <span className="text-red-500">Flex</span></p>
              ...
              <nav className="hidden md:flex space-x-10">
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="
                     group bg-transparent rounded-md text-gray-100 shad  inline-flex items-center text-base font-medium hover:text-gray-200 focus:outline-none  pb-8'
                    "
            ...
            */}
                ...
                <a
                  href="#"
                  className="text-base font-medium text-gray-100 shad  hover:text-gray-200"
                >
                  Pricing
                </a>
                <a
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="group bg-transparent text-gray-100 shad  rounded-md  inline-flex items-center text-base font-medium hover:text-gray-200 focus:outline-none "
            ...
            */}{" "}
              ...
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                <a
                  href="#"
                  className="whitespace-nowrap text-base font-medium text-gray-100 shad  shad hover:text-gray-200"
                >
                  Sign in
                </a>
                <a
